...
def create_choice(choice_text, question):
    """
    Create a choice with the given `choice_text` and linked to the given `question`.
    """
...
class QuestionResultsViewTest(TestCase):
    ...
    def test_past_question(self):
        """
        The results view of a question with a pub_date in the past displays the question's text and
        all choices' text.
        """
        past_question = create_question('past question', days=-5)
